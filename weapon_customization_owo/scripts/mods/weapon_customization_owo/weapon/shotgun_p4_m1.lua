...
mod.mt.inject_fixes(this_variant, {
    ...
    {   dependencies =      { "owo_sight_group_indicator_holosight_razor", _owo_magnifier_vortex_sights, },
        ...
        -- to aim with, but the shell rack (top) doesn't rotate much
        -- sight_2 needs to be counter rotated and shift a bit right/down, since it's not looking straight through the sights
        scope_offset =      { offset = true, position = vector3_box(-0.072, -0.02, 0.103), rotation = vector3_box(-5, 0, -7), lense_transparency = true },
        sight_2 =           { parent = "sight", position = vector3_box(0.00, -0.02, 0.004), rotation = vector3_box(2.5, 0, 2.5), scale = vector3_box(1, 1, 0.769), hide_mesh = {{"sight_2", 5,6,}}, },
    },
    ...
    {   dependencies =      { --"owo_sight_group_indicator_prismatic_sight_acog", 
        ...
        -- to aim with, but the shell rack (top) doesn't rotate much
        -- sight_2 needs to be counter rotated and shift a bit right/down, since it's not looking straight through the sights
        scope_offset =      { offset = true, position = vector3_box(-0.048, -0.02, 0.085), rotation = vector3_box(-5, 0, -5), lense_transparency = true },
        sight_2 =           { parent = "sight", position = vector3_box(0.005, -0.02, -0.001), rotation = vector3_box(3, 0, 3), scale = vector3_box(1, 1, 0.769), hide_mesh = {{"sight_2", 5,6,}}, },
    },
    {   dependencies =      { --"owo_sight_group_indicator_prismatic_sight_acog", 
        ...
        -- to aim with, but the shell rack (top) doesn't rotate much
        -- sight_2 needs to be counter rotated and shift a bit right/down, since it's not looking straight through the sights
        scope_offset =      { offset = true, position = vector3_box(-0.048, -0.02, 0.087), rotation = vector3_box(-5, 0, -5), lense_transparency = true },
        sight_2 =           { parent = "sight", position = vector3_box(0.005, -0.02, -0.001), rotation = vector3_box(3.25, 0, 3.25), scale = vector3_box(1, 1, 0.769), hide_mesh = {{"sight_2", 5,6,}}, },
    },
    --  --------------------------------------------
    --  SUSAT
    --  --------------------------------------------
