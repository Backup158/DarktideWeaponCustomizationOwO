...
mod.mt.inject_fixes(this_variant, {
    ...
    {   dependencies =      { "owo_sight_group_indicator_holosight_eotech", _owo_no_magnifier_eotech_sights },
        ...
        -- sight_2 needs to be counter rotated
        no_scope_offset =   { offset = true, position = vector3_box(-0.06, -0.02, 0.102), rotation = vector3_box(-5, 0, -7), lense_transparency = true },
        scope_offset =      { offset = true, position = vector3_box(-0.06, -0.02, 0.102), rotation = vector3_box(-5, 0, -7), lense_transparency = true },
        sight_2 =           { parent = "sight", position = vector3_box(-0.002, -0.02, 0.01), rotation = vector3_box(0, 0, 0), scale = vector3_box(1, 1, 0.769), hide_mesh = {{"sight_2", 3,4,5,6,}}, },
    },
