...
mod.mt.inject_fixes(this_variant, {
    ...
    {	dependencies = {"owo_underbarrel_shotgun_02"},
        -- Receiver
        bayonet =       { offset = false, parent = "receiver", position = vector3_box(0, 0.25, -0.188), rotation = vector3_box(0, 0, 0), scale = vector3_box(0.8, 0.85, 0.65 ) },
    },
    --  M26-MASS Helpers
    {	dependencies = {"owo_underbarrel_shotgun_02"},
        -- Mag
    ...
    {   dependencies = { _owo_magnifier_side_holographic_sights },
        scope_offset =      { position = vector3_box(0, -0.0001, -0.0373), rotation = vector3_box(0, 0, 0),  },
    },
    ...
    {   dependencies = { "owo_acog_sight_02_top|owo_acog_sight_02f_top" },
        scope_offset =      { position = vector3_box(0.0002, 0.001, -0.1175), rotation = vector3_box(0, 0, 0),  },
    },
    --      Aiming with RMR on SUSAT
    {   dependencies = { "owo_susat_02_top" },
        scope_offset =      { position = vector3_box(0.0002, 0.001, -0.1035), rotation = vector3_box(0, 0, 0),  },
    },
