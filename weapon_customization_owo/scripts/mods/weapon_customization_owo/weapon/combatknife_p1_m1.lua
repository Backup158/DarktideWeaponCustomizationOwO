...
mod.mt.inject_fixes(this_variant, {
    ...
    {   dependencies =  { _mt_tactical_axe_grips, _owo_finger_guards },
        frontguard =    { offset = true, position = vector3_box(0, 0, 0.214), rotation = vector3_box(0, 0, 0), scale = vector3_box(0.36, 0.5, 0.8 ), },
    },
    ...
    {   dependencies =  { _mt_ogryn_grips, "owo_historical_blade_01" },
        body =          { offset = true, position = vector3_box(0, -0.004, 0.036), rotation = vector3_box(90, 0, 0), scale = vector3_box(2.0, 2.3, 2.15 ), },
    },
