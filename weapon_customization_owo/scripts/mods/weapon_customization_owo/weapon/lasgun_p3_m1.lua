...
mod.mt.inject_fixes(this_variant, {
    ...
    {	dependencies =  { _owo_masterkey_bayonets, _syn_volleygun_receivers, },
        -- Receiver
        bayonet =       { offset = true, position = vector3_box(0, 0, 0), },
    },
    --      Recon Receivers
    {	dependencies =  { _owo_masterkey_bayonets,
        ...
        -- Receiver
        bayonet =       { offset = true, position = vector3_box(0, 0.045, -0.035), },
    },
    --  --------------------------------------------
    --  M26-MASS
    --  --------------------------------------------
    --      Syn's Volleygun Receivers
    {	dependencies =  { "owo_underbarrel_shotgun_m26mass", _syn_volleygun_receivers, },
        -- Receiver
