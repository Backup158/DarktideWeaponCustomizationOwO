...
mod.mt.inject_fixes(this_variant, {
    ...
    --  -------------------------------------------
    {   dependencies =      { "owo_holosight_02_01|owo_holosight_02_01ss" },
        scope_offset =      { position = vector3_box(0.002, -0.0, -0.0385), rotation = vector3_box(0, 0, 0), lense_transparency = true },
    },
    {   dependencies =      { _owo_no_magnifier_eotech_sights },
    ...
    {   dependencies =      { _owo_magnifier_side_eotech_sights },
        scope_offset =      { position = vector3_box(0.002, 0, -0.0345), rotation = vector3_box(0, 0, 0),  },
    },
