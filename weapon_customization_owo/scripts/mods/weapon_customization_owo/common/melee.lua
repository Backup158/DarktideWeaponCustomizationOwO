...
function mod.owo_polearm_head(variant_id, given_type, given_parent)
	...
	mod.inject_attachments_owo(variant_id, current_type, {
		...
		{id = "owo_polearm_head_bc_01b", name = "OwO CAW MOTHERF-"},
		{id = "owo_polearm_head_bc_02b", name = "OwO CAW CAW MOTHERF-"},
		{id = "owo_polearm_head_bc_03b", name = "OwO CAW CAW CAW MOTHERF-"},
		{id = "owo_polearm_head_bc_04b", name = "OwO CAW CAW CAW CAW MOTHERF-"},
