...
function mod.fixes_owo_telescopic_sight(variant_id)
	...
	mod.mt.inject_fixes(variant_id, {
		...
		{   dependencies =  	{ _owo_all_acog_sights },
			...
			-- Reticle
			sight_2 =           { offset = false, parent = "sight", position = vector3_box(0, 0.0, 0.1), rotation = vector3_box(0, 0, 0), scale = vector3_box(1, 1, 1), hide_mesh = { {"sight_2", 5,6 }, }, animation_wait_attach = { "rail" }, },
			-- Lenses
