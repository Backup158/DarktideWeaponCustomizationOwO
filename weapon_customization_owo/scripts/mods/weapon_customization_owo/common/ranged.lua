...
function mod.fixes_owo_holosight(variant_id, given_type)
	local current_type = given_type or "sight"
    ...
    {   dependencies =  { _owo_all_eotech_sights },
		rail =          { offset = true, position = vector3_box(0, -0.02, 0.0), rotation = vector3_box(0, 0, 0), scale = vector3_box(1, 1, 1), },
