...
mod.inject_fixes(this_variant, {
    ...
    {   dependencies = { "owo_holosight_03_01|owo_holosight_03_02|owo_holosight_03_03",
        ...
        scope_offset =      { position = vector3_box(0, -0.0001, 0.024125), rotation = vector3_box(0, 0, 0)},
    },
	{   dependencies = { "owo_holosight_03_01|owo_holosight_03_02|owo_holosight_03_03",
			"receiver_01|receiver_02|receiver_03|receiver_04|receiver_05|receiver_06|receiver_07",
		},
        no_scope_offset =   { position = vector3_box(0, -0.0001, -0.0253), rotation = vector3_box(0, 0, 0)},
        scope_offset =      { position = vector3_box(0, -0.0001, -0.0253), rotation = vector3_box(0, 0, 0)},
    },
    --      Point shooting
	...
	{   dependencies = { "owo_acog_sight_01|owo_acog_sight_01_ps|owo_acog_sight_02_01|owo_acog_sight_02_02|owo_acog_sight_02_ps",
        ...
        sight =             { offset = true, position  = vector3_box(0, 0.092, 0.19), rotation = vector3_box(0, 0, 0), scale = vector3_box(1, 1, 1) },
    },
	...
	{   dependencies = { "owo_acog_sight_01|owo_acog_sight_02_01",
        ...
        no_scope_offset =   { position = vector3_box(0, -0.0001, -0.0835), rotation = vector3_box(0, 0, 0)},
        scope_offset =      { position = vector3_box(0, -0.0001, -0.0835), rotation = vector3_box(0, 0, 0)},
    },
    --      Aiming with RMR
	...
	{   dependencies = { "owo_acog_sight_02_02",
        ...
        no_scope_offset =   { position = vector3_box(0.0002, 0.001, -0.160), rotation = vector3_box(0, 0, 0)},
        scope_offset =      { position = vector3_box(0.0002, 0.001, -0.160), rotation = vector3_box(0, 0, 0)},
    },
    --      Point shooting
