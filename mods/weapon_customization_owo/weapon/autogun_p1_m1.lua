...
mod.inject_fixes(this_variant, {
    {   dependencies = {
	    ...
	    muzzle = {offset = true, position = vector3_box(0, 0.008, 0), rotation = vector3_box(0, 0, 0), scale = vector3_box(1, 1.9, 1)}
    },
	{   dependencies = {
            "owo_dreg_barrel_01",
            "autogun_bayonet_01|autogun_bayonet_02"
        }, -- Barrel
	    bayonet = {offset = true, position = vector3_box(0, 0.27, -0.038), rotation = vector3_box(0, 0, 0), scale = vector3_box(1, 1., 1)}
    },
	{   dependencies = {
            "owo_dreg_barrel_01"
        },
	    barrel = {offset = true, position = vector3_box(0, 0.191, 0.003), rotation = vector3_box(0, 0, 0), scale = vector3_box(0.6, 0.6, 0.6)},
        barrelshroud = {offset = true, position = vector3_box(0, 0.192, 0.003), rotation = vector3_box(0, 0, 0), scale = vector3_box(0.6, 0.6, 0.6)},
	    barrelshroudac = {offset = true, position = vector3_box(0, -0.286, -.098), rotation = vector3_box(0, 180, 0), scale = vector3_box(0.64, 1.2, 0.7)},
	    ...
	    muzzle = {offset = true, position = vector3_box(0, -0.034, 0), rotation = vector3_box(0, 0, 0), scale = vector3_box(1, 1.55, 1)}
    },
})