...
-- #region #### Common Files ####
-- ##############################
mod.load_mod_file("common/ranged")
--mod.load_mod_file("common/melee")
--#end region Common Files
...
--#region #### Melee #####
--[[
mod.load_mod_file("weapon/combatknife_p1_m1")

mod.load_mod_file("weapon/combatsword_p1_m1")

mod.load_mod_file("weapon/combatsword_p2_m1")

mod.load_mod_file("weapon/combatsword_p3_m1")

mod.load_mod_file("weapon/powersword_p1_m1")

mod.load_mod_file("weapon/forcesword_p1_m1")

mod.load_mod_file("weapon/ogryn_combatblade_p1_m1")

mod.load_mod_file("weapon/ogryn_powermaul_p1_m1")

mod.load_mod_file("weapon/ogryn_club_p1_m1")

mod.load_mod_file("weapon/ogryn_club_p2_m1")

mod.load_mod_file("weapon/ogryn_pickaxe_2h_p1_m1")

mod.load_mod_file("weapon/ogryn_powermaul_slabshield_p1_m1")

mod.load_mod_file("weapon/powermaul_2h_p1_m1")
mod.load_mod_file("weapon/powermaul_p1_m1")
mod.load_mod_file("weapon/thunderhammer_2h_p1_m1")

mod.load_mod_file("weapon/combataxe_p1_m1")

mod.load_mod_file("weapon/combataxe_p2_m1")

mod.load_mod_file("weapon/combataxe_p3_m1")

mod.load_mod_file("weapon/chainaxe_p1_m1")

mod.load_mod_file("weapon/chainsword_p1_m1")

mod.load_mod_file("weapon/chainsword_2h_p1_m1")
]]
--#end region Weapons