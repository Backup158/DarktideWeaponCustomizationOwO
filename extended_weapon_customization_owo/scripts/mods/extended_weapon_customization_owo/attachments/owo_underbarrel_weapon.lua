...
function mod.owo_underbarrel_weapon_veteran_guardsman_laspistol(given_slot, given_attachment_node)
    ...
    -- adding helpers
    local owo_kitbash_base_bolt_pistol = _item_ranged.."/underbarrels/owo_underbarrel_weapon_bolt_pistol"
    create_kitbash_full_item(table_to_return, owo_kitbash_base_bolt_pistol, nil, "content/weapons/player/ranged/bolt_pistol/attachments/receiver_01/receiver_01", current_attachment_node)
    create_kitbash_full_item(table_to_return, owo_kitbash_base_bolt_pistol.."_grip", nil, "content/weapons/player/ranged/bolt_pistol/attachments/grip_01/grip_01", current_attachment_node)
    create_kitbash_full_item(table_to_return, owo_kitbash_base_bolt_pistol.."_magazine", nil, "content/weapons/player/ranged/bolt_pistol/attachments/magazine_01/magazine_01", current_attachment_node)
    create_kitbash_full_item(table_to_return, owo_kitbash_base_bolt_pistol.."_barrel", nil, "content/weapons/player/ranged/bolt_pistol/attachments/barrel_01/barrel_01", current_attachment_node)


    local name_suffix = "bolt_pistol"
