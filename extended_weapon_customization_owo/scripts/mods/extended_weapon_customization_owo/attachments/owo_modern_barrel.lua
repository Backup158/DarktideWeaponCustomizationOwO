...
function mod.owo_kalashnikov_barrel(given_slot, given_attachment_node)
    ...
    -- Long Barrels (3 and 4 but the bag on 4 looks wrong
    ...
    local type1_short_distance = 0.268
    local type1_super_short_distance = 0.2
    ...
    if all_these_attachments then
        ...
        mod.all_owo_kalashnikov_barrel_names.type1 = mod.create_requirements_string_from_names_table(amod.all_owo_kalashnikov_barrel_names.type1)
        ...
        mod.all_owo_kalashnikov_barrel_names.type2 = mod.create_requirements_string_from_names_table(amod.all_owo_kalashnikov_barrel_names.type2)
        mod.all_owo_kalashnikov_barrel_names.all = mod.all_owo_kalashnikov_barrel_names.type1.."|"..mod.all_owo_kalashnikov_barrel_names.type2
    end
