...
function mod.owo_kalashnikov_barrel(given_slot, given_attachment_node)
    ...
    if all_these_attachments then
        ...
        for type_of_kalashnikov_barrel, table_containing_variants_with_name_arrays in pairs(all_these_attachments) do
            ...
            table_insert(final_all_requirements, all_these_attachments[type_of_kalashnikov_barrel].all)
        end
