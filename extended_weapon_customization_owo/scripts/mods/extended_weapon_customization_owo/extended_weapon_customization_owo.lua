...
mod.version = "4.8.0-waagh-mr-bond"
...
-- Barrel Shroud
-- ----------------
add_attachments_to_list_of_weapons(mod.owo_suppressor("barrel_foreskin", "ap_muzzle_01"), ranged_muzzle_no_double, "barrel_foreskin")
